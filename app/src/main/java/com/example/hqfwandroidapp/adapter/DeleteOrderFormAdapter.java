...
public class DeleteOrderFormAdapter extends RecyclerView.Adapter<DeleteOrderFormAdapter.ViewHolder>{
    // context
    private Context context;
    // data list
    private List<OrderForm> orderFormList = new ArrayList<>();

    public DeleteOrderFormAdapter(Context context) {
        this.context = context;
    }

    public DeleteOrderFormAdapter(Context context, List<OrderForm> orderFormList) {
        this.context = context;
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        // recycler view
        @BindView(R.id.rv_purchased_item) RecyclerView rv_commodity_confirm;
        // total price
